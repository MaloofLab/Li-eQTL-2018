...
LG.f2.after.crossover$pheno[,c("Arachidic_acid", "cis_11_Eicosenoic_acid", "Linolenic_acid", "Behenic_acid")]
...
# save output 
save(scantwo.imp, file = "/share/malooflab/Ruijuan/F2/QTL_analysis/output/scantwo.imp.v2.flipped.3.Rdata")

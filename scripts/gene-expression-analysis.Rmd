...
hist(heritability$heritability, breaks = 100) 
min(heritability$heritability) 

sum(heritability$heritability < -50)

# finish this tomorrow 
# heritability < 0 should be == 0, and look for heritability for genes with eQTL and w/o eQTL 
```

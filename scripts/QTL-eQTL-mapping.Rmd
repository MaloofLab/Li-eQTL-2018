...
LG.f2.after.crossover <- read.cross("csvsr", 
                     genfile = "LG.f2.madmapper.final.flipped_gen_C05C08.csv_gen.csv",
...
save(scanone.perm.imp, scanone.imp, cim.qtl, cim.perm, file = QTL_result_all.C05C08.Rdata)
```
...
write.csv(vstMat.f2.batch.corrected, file = "vstMat.f2.batch.corrected.csv") # check the file format to make sure it is the right format for R/qtl package 

# eQTL mapping 
cross.F2 <- read.cross("csvsr", genfile ="LG.f2.madmapper.final_gen_revised_flipped_C05C08.csv", 
                         phefile = "vstMat.f2.batch.corrected.csv", 
                         genotypes = c("AA", "AB", "BB"))   

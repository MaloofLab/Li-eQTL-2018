...
scantwo.perm.imp.6.10 <- 
  scantwo(LG.f2.after.crossover,pheno.col=11:12,method="hk",n.perm=10,n.cluster = 16)
)

sfStop()

# save output 
save(scantwo.perm.imp.6.10, file = "/share/malooflab/Ruijuan/F2/QTL_analysis/output/scantwo_flipped/scantwo.perm.imp.6.10.Rdata")
